  ...
  export default {
    ...
    methods: {
      ...
      onSubmit() {
        ...
        reqBody.name = this.invoice.name;
        reqBody.paid = this.invoice.total_price;
        reqBody.txn_names = txn_names;
        reqBody.txn_prices = txn_prices;
        reqBody.user_id = this.user.id;

        console.log(reqBody, this.transactions);
        ...
        // Post to server
        axios.post("http://localhost:3128/invoice", reqBody).then(res => {
